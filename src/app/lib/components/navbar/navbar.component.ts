...
export class NavbarComponent implements OnInit {
    ...
    minimizeSidebar() {
        ...
        if (misc.sidebar_mini_active === true) {
            ...
            window.localStorage.setItem('sidebar_mini', JSON.stringify(false));

        } else {
            setTimeout(function () {
                body.classList.add('sidebar-mini');

                window.localStorage.setItem('sidebar_mini', JSON.stringify(true));
    ...
    ngOnInit() {
        ...
        if (JSON.parse(window.localStorage.getItem('sidebar_mini'))) {
            body.classList.add('sidebar-mini');
        }
